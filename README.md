...
## 📝 Habilidades adquiridas
  ...
  3.  Utilizar a função setState de forma a garantir que um determinado código só é executado após o estado ser 
      atualizado;
  ...
  7.  Criar links de navegação na aplicação com o componente Link;
